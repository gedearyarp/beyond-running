      ...
      <main className="flex-1 pt-[88px]">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-40">
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-itc-demi mb-8 md:hidden">{event.title}</h1>
            ...
            <div>
              <h1 className="text-3xl md:text-[42px] font-itc-demi mb-8 hidden md:block">{event.title}</h1>
