                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        <h2 className="text-xl md:text-2xl font-bold text-black mb-6 md:mb-8">
                            ORDER HISTORY ({orders.length.toString().padStart(2, "0")})
                        </h2>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            ...
                                            <a
                                                href={orderData.order_status_url}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="bg-black text-white px-4 py-2 text-xs font-medium hover:bg-gray-900 transition-colors rounded"
                                            >
                                                ORDER STATUS
                                            </a>
                                        </div>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    ...
                                    {orders.map((order) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <td className="py-6 px-0 text-black font-medium">
                                                    {orderData.name || `#${order.id}`}
                                                </td>
                                                ...
                                                <td className="py-6 px-0 text-right">
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="bg-black text-white px-6 py-2 text-sm font-medium hover:bg-gray-900 transition-colors rounded"
                                                    >
                                                        ORDER STATUS
                                                    </a>
                                                </td>
