...
export default function SignupForm() {
    ...
    return (
        <div className="w-full max-w-md mx-auto px-6">
            <h1 className="md:text-4xl text-xl font-bold text-center mb-16 font-itc-demi">
                CREATE AN ACCOUNT
            </h1>
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <label
                            htmlFor="firstName"
                            className="block font-folio-bold text-sm md:text-lg"
                        >
                            First Name
                        </label>
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <label
                        htmlFor="newsletter"
                        className="text-sm md:text-lg text-[#292929] font-folio-bold"
                    >
