                ...
                {isCartValidation && outOfStockItems.length > 0 ? (
                    <div>
                        <p className="font-folio-light text-gray-600 mb-4">
                            The following items are no longer available and have been removed from
                            your cart:
                        </p>
                    ...
                    <p className="font-folio-light text-gray-600 mb-6">
                        We're sorry, but this product is currently unavailable. Please check back
                        later or explore other variants or products.
                    </p>
                )}
